...
export default class Larva {
    ...
    update(deltaTime) {
        ...
        if (this.collisionY < this.game.marginTop + 50) {
            ...
            this.game.score++;
            for (let i = 0; i < 3; ++i) {
                this.game.particles.push(new Firefly(this.game, this.collisionX, this.collisionY, "#a3e635"));
            }
        }
        ...
        this.game.enemies.forEach((enemy) => {
            if (this.game.checkCollision(this, enemy).isCollision) {
                this.makedForDeletetion = true;
                for (let i = 0; i < 5; ++i) {
                    this.game.particles.push(new Spark(this.game, this.collisionX, this.collisionY, "#ef4444"));
                }
